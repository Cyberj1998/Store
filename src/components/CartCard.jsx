...
const CartCard = ({ item }) => {
  ...
  return (  
    <div className="rounded-2xl bg-white flex items-center justify-between p-4 m-2 w-[90%] max-w-[90%] max-md:h-50 relative shrink-0 border border-gray-300 shadow-md hover:shadow-xl transition-shadow duration-300">
