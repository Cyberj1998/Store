...
const ProductCard = ({ product }) => {
  ...
  return ( 
    <div className="w-70 md:w-60 max-md:w-70 max-sm:w-45 h-auto max-md:h-auto bg-white p-4 flex flex-col items-center gap-4 rounded-3xl m-3 border border-gray-300 shadow-md hover:shadow-xl transition-shadow duration-300">
      <img
        src={product.image}
        alt={product.name}
